  ...
  (
    ...
    return (
      <section
        ref={ref}
        className={cn(
          "relative z-0 mt-16  flex min-h-[80vh]  w-full flex-col items-center justify-center overflow-hidden rounded-md bg-background",
          className,
        )}
        {...props}
      >
        ...
        >
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div className="mb-6 text-xs px-3 py-1 flex items-center justify-center gap-1 bg-primary/10 rounded-full shadow-md">
              <span>🔥</span>
              ...
              <div className={cn("flex gap-4", actionsClassName)}>
                {actions.map((action, index) => (
                  <Button
                    ...
                    asChild
                  >
                    <Link href={'/grammer'}>{action.label}</Link>
                  </Button>
                ))}
              </div>
            )}
