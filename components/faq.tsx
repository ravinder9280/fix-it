...
function Faq02() {
    ...
    return (
        <section className="p-8 md:p-12 w-full bg-linear-to-b from-transparent via-gray-50/50 to-transparent dark:from-transparent dark:via-white/[0.02] dark:to-transparent">
